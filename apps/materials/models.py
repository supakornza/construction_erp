...
class MaterialDelivery(models.Model):
    ...
    source_area = models.ForeignKey(WorkArea, on_delete=models.SET_NULL, null=True, blank=True, related_name='source_deliveries', verbose_name='แหล่งวัสดุ (Work Area)')
    ...
    source = models.CharField(max_length=200, blank=True, verbose_name='แหล่งวัสดุ (ข้อความ)')
